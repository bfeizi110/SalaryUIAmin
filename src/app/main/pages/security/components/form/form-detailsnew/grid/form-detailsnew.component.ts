...
import { FormDetailAttr, FormDetailNewAttr, setFormDetailAttr, setFormDetailNewAttr } from 'src/app/main/pages/global-attr'

const Controller = 'FormDetailsNew'

@Component({
  selector: 'form-detailsnew',
  templateUrl: './form-detailsnew.component.html',
  styleUrls: ['./form-detailsnew.component.scss']
})
export class FormDetailsNewComponent {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setFormDetailNewAttr(attr) : null
    this.getSelect()
  }
  ...
  constructor(private service: GridFormService, private formBuilder: FormBuilder, private toastr: ToastrService) { }
