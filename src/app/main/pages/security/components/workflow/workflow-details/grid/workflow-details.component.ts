import { WorkFlowDetailAttr, setWorkFlowDetailAttr } from './../../../../../global-attr';
...
export class WorkFlowDetailsComponent {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setWorkFlowDetailAttr(attr) : null
    this.getSelect()
  }

  getSelect() {
    this.showGrid = false
    this.service.getSelect(Controller, this.WorkFlowID).subscribe((res: any) => {
