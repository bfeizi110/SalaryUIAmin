...
import { YektaAttr, setYektaAttr } from '../../../../global-attr'

const Controller = 'YektaStruct'

@Component({
  templateUrl: './yektastruct.component.html',
  styleUrls: ['./yektastruct.component.scss']
})

export class YektaStructComponent implements OnInit {
  ...
  getAttr() {
    ...
    !YektaAttr
      ...
      : this.setAttr(YektaAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setYektaAttr(attr) : null
    this.getSelect()
  }
