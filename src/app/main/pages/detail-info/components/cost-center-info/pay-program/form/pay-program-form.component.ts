...
@Component({
  selector: 'pay-program-form',
  templateUrl: './pay-program-form.component.html',
  styleUrls: ['./pay-program-form.component.scss']
})
export class PayProgramFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      formType: this.formType, modatTitle: 'برنامه های پرداخت',
