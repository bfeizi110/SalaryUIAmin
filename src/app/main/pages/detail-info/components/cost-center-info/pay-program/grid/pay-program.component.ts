...
import { PayProgramAttr, setPayProgramAttr } from 'src/app/main/pages/global-attr'

const Controller = 'PayProgram'

@Component({
  templateUrl: './pay-program.component.html',
  styleUrls: ['./pay-program.component.scss']
})

export class PayProgramComponent implements OnInit {
  ...
  getAttr() {
    ...
    !PayProgramAttr
      ...
      : this.setAttr(PayProgramAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setPayProgramAttr(attr) : null
    this.getSelect()
  }
