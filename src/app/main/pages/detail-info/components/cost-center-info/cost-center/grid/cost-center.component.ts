...
import { CostCenterAttr, setCostCenterAttr } from 'src/app/main/pages/global-attr'

const Controller = 'CostCenter'
...
export class CostCenterComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setCostCenterAttr(attr) : null
    this.getSelect()
  }
