...
@Component({
  selector: 'hire-type-param-form',
  templateUrl: './hire-type-param-form.component.html',
  styleUrls: ['./hire-type-param-form.component.scss']
})

export class HireTypeParamFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      Id: [0],
      HireIDDesc: [null],
      HireID: [{ value: this.hireId, disabled: Validation.disable('hireId') }, Validation.setValidator('hireId')],
      ParamIDDesc: [null],
      ParamID: [{ value: null, disabled: Validation.disable('ParamID') }, Validation.setValidator('ParamID')],
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      ...
      modatTitle: 'پارامتر های انواع استخدام',
