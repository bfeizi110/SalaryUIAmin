...
export class ParameterFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      EnName: [{ value: null, disabled: Validation.disable('EnName') }, Validation.setValidator('EnName')],
    ...
    // this.formType == 'Add' ? this.form.get('Name').valueChanges.subscribe(val => this.form.controls.CodeDesc_Fld.setValue(val)) : this.form.setValue(this.data)
    this.showModal = true
  }
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      formType: this.formType, modatTitle: 'پارامتر',
