...
@Component({
  selector: 'hire-stage-form',
  templateUrl: './hire-stage-form.component.html',
  styleUrls: ['./hire-stage-form.component.scss']
})
export class HireStageFormComponent implements OnInit {
