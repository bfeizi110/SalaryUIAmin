...
@Component({
  selector: 'hire-state-form',
  templateUrl: './hire-state-form.component.html',
  styleUrls: ['./hire-state-form.component.scss']
})
export class HireStateFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      BazDesc_Fld: [{ value: null, disabled: Validation.disable('BazDesc_Fld') }, Validation.setValidator('BazDesc_Fld')],
