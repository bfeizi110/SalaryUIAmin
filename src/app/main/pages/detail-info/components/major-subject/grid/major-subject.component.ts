...
import { MajorSubjectAttr, setMajorSubjectAttr } from '../../../../global-attr'

const Controller = 'MajorSubject'

@Component({
  templateUrl: './major-subject.component.html',
  styleUrls: ['./major-subject.component.scss']
})
export class MajorSubjectComponent implements OnInit {
  ...
  getAttr() {
    ...
    !MajorSubjectAttr
      ...
      : this.setAttr(MajorSubjectAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setMajorSubjectAttr(attr) : null
    this.getSelect()
  }
