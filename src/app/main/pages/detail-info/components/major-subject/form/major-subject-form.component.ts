...
@Component({
  selector: 'major-subject-form',
  templateUrl: './major-subject-form.component.html',
  styleUrls: ['./major-subject-form.component.scss']
})

export class MajorSubjectFormComponent implements OnInit {
