...
import { ListNoAttr, setListNoAttr, setSlackGroupAttr, SlackGroupAttr } from 'src/app/main/pages/global-attr'

const Controller = 'SlackGroup'

@Component({
  templateUrl: './slackgroup.component.html',
  styleUrls: ['./slackgroup.component.scss']
})
export class SlackGroupComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setSlackGroupAttr(attr) : null
    this.getSelect()
  }
