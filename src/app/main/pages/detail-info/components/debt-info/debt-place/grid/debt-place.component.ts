...
import { DebtPlaceAttr, setDebtPlaceAttr } from 'src/app/main/pages/global-attr'

const Controller = 'DebtPlace'

@Component({
  templateUrl: './debt-place.component.html',
  styleUrls: ['./debt-place.component.scss']
})

export class DebtPlaceComponent implements OnInit {
  ...
  getAttr() {
    ...
    !DebtPlaceAttr
      ...
      : this.setAttr(DebtPlaceAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setDebtPlaceAttr(attr) : null
    this.getSelect()
  }
