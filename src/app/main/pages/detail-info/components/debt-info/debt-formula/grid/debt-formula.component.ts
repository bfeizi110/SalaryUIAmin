...
import { DebtFormulaAttr, setDebtFormulaAttr } from '../../../../../global-attr'

const Controller = 'DebtFormula'

@Component({
  templateUrl: './debt-formula.component.html',
  styleUrls: ['./debt-formula.component.scss']
})

export class DebtFormulaComponent implements OnInit {
  ...
  getAttr() {
    ...
    !DebtFormulaAttr
      ...
      : this.setAttr(DebtFormulaAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setDebtFormulaAttr(attr) : null
    this.getSelect()
  }
