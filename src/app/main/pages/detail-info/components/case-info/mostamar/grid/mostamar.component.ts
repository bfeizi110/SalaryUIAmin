...
import { MostamarAttr, setMostamarAttr } from '../../../../../global-attr'

const Controller = 'Mostamar'

@Component({
  templateUrl: './mostamar.component.html',
  styleUrls: ['./mostamar.component.scss']
})
export class MostamarComponent implements OnInit {
  ...
  getAttr() {
    ...
    !MostamarAttr
      ...
      : this.setAttr(MostamarAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setMostamarAttr(attr) : null
    this.getSelect()
  }
