...
import { GradeLiceseAttr, setGradeLiceseAttr } from '../../../../global-attr'

const Controller = 'GradeLicense'

@Component({
  templateUrl: './grade-license.component.html',
  styleUrls: ['./grade-license.component.scss']
})
export class GradeLicenseComponent implements OnInit {
  ...
  getAttr() {
    ...
    !GradeLiceseAttr
      ...
      : this.setAttr(GradeLiceseAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setGradeLiceseAttr(attr) : null
    this.getSelect()
  }
