...
@Component({
  selector: 'bank-format-form',
  templateUrl: './bank-format-form.component.html',
  styleUrls: ['./bank-format-form.component.scss']
})

export class BankFormatFormComponent {
