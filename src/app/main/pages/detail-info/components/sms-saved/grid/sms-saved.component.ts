...
import { SmsSavedAttr, setSmsSavedAttr } from 'src/app/main/pages/global-attr'

const Controller = 'SmsSaved'

@Component({
  selector: 'sms-saved',
  templateUrl: './sms-saved.component.html',
  styleUrls: ['./sms-saved.component.scss']
})
export class SmsSavedComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setSmsSavedAttr(attr) : null
    this.getSelect()
  }
