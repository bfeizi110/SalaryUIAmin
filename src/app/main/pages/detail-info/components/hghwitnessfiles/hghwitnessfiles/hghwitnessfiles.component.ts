...
import { HghWitnessFilesAttr, setHghWitnessFilesAttr } from 'src/app/main/pages/global-attr'

const Controller = 'HghWitnessFiles'

@Component({
  templateUrl: './hghwitnessfiles.component.html',
  styleUrls: ['./hghwitnessfiles.component.scss']
})
export class HghWitnessFilesComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setHghWitnessFilesAttr(attr) : null
    this.getSelect()
  }
