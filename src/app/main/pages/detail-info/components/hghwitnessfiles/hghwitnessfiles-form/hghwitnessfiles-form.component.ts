...
@Component({
  selector: 'hghwitnessfiles-form',
  templateUrl: './hghwitnessfiles-form.component.html',
  styleUrls: ['./hghwitnessfiles-form.component.scss']
})
export class HghWitnessFilesFormComponent {
  ...
  ngOnChanges(UpdatedValue: string): void {
    ...
    this.modalOptions = {
      ...
      modatTitle: 'خروجی گواهی حقوق و ضمانت',
