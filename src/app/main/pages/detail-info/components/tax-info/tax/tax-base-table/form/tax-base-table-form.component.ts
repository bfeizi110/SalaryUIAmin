...
@Component({
  selector: 'tax-base-table-form',
  templateUrl: './tax-base-table-form.component.html',
  styleUrls: ['./tax-base-table-form.component.scss']
})

export class TaxBaseTableFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      Id: [0],
      TaxType_Fld: [{ value: null, disabled: Validation.disable('TaxType_Fld') }, Validation.setValidator('TaxType_Fld')],
      TaxTypeDesc_Fld: [null],
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      formType: this.formType, modatTitle: 'اسامی جداول مالیاتی',
