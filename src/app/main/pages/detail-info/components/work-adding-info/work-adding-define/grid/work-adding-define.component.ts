...
import { setWorkAddingDefineAttr, WorkAddingDefineAttr } from '../../../../../global-attr'

const Controller = 'WorkAddingDefine'

@Component({
  templateUrl: './work-adding-define.component.html',
  styleUrls: ['./work-adding-define.component.scss']
})

export class WorkAddingDefineComponent implements OnInit {
  ...
  getAttr() {
    this.showGrid = false
    !WorkAddingDefineAttr
      ? this.service.getAttr(Controller).subscribe((res: any) => this.setAttr(res.Data, 'toLocal'))
      : this.setAttr(WorkAddingDefineAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setWorkAddingDefineAttr(attr) : null
    this.getSelect()
  }
