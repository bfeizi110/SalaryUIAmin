...
import { NewFormulaDescAttr, setNewFormulaDescAttr } from 'src/app/main/pages/global-attr'

const Controller = 'NewFormulaDetail'

@Component({
  selector: 'new-formula-detail',
  templateUrl: './new-formula-detail.component.html',
  styleUrls: ['./new-formula-detail.component.scss']
})
export class NewFormulaDetailComponent {
  ...
  getAttr() {
    !NewFormulaDescAttr
      ...
      : this.setAttr(NewFormulaDescAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setNewFormulaDescAttr(attr) : null
    this.getSelect()
  }
  ...
  getSelect() {
    this.showGrid = false
    this.service.getSelect(Controller, this.newFormulaId).subscribe((res: any) => {
