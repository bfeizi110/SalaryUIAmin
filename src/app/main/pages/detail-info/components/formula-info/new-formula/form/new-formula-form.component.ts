...
const Controller = 'NewFormula'

@Component({
  selector: 'new-formula-form',
  templateUrl: './new-formula-form.component.html',
  styleUrls: ['./new-formula-form.component.scss']
})
export class NewFormulaFormComponent implements OnInit {
