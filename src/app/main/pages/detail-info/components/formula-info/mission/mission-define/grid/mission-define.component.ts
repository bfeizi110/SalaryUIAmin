...
import { MissionDefineAttr, setMissionDefineAttr } from 'src/app/main/pages/global-attr'

const Controller = 'MissionDefine'

@Component({
  selector: 'mission-define',
  templateUrl: './mission-define.component.html',
  styleUrls: ['./mission-define.component.scss']
})

export class MissionDefineComponent implements OnInit {
  ...
  getAttr() {
    ...
    !MissionDefineAttr
      ...
      : this.setAttr(MissionDefineAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setMissionDefineAttr(attr) : null
    this.getSelect()
  }
