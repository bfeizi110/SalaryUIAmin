...
import { InsureJobAttr, setInsureJobAttr } from '../../../../../global-attr'

const Controller = 'InsureJob'

@Component({
  templateUrl: './insure-job.component.html',
  styleUrls: ['./insure-job.component.scss']
})

export class InsureJobComponent implements OnInit {
  ...
  getAttr() {
    ...
    !InsureJobAttr
      ...
      : this.setAttr(InsureJobAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setInsureJobAttr(attr) : null
    this.getSelect()
  }
