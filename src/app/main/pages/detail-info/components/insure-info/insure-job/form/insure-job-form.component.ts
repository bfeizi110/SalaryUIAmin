...
@Component({
  selector: 'insure-job-form',
  templateUrl: './insure-job-form.component.html',
  styleUrls: ['./insure-job-form.component.scss']
})

export class InsureJobFormComponent implements OnInit {
