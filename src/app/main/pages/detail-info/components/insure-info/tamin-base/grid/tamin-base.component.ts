...
import { setTaminBaseAttr, TaminBaseAttr } from '../../../../../global-attr'

const Controller = 'TaminBase'

@Component({
  templateUrl: './tamin-base.component.html',
  styleUrls: ['./tamin-base.component.scss']
})

export class TaminBaseComponent implements OnInit {
  ...
  getAttr() {
    ...
    !TaminBaseAttr
      ...
      : this.setAttr(TaminBaseAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setTaminBaseAttr(attr) : null
    this.getSelect()
  }
