...
import { ExemptSettingAttr, setExemptSettingAttr } from 'src/app/main/pages/global-attr'

const Controller = 'ExemptSetting'

@Component({
  templateUrl: './exempt-setting.component.html',
  styleUrls: ['./exempt-setting.component.scss']
})
export class ExemptSettingComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setExemptSettingAttr(attr) : null
    this.getSelect()
  }
