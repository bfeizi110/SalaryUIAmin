...
import { ImportDetailAttr, setImportDetailAttr } from 'src/app/main/pages/global-attr'

const Controller = 'ImportSettingDetail'

@Component({
  selector: 'import-setting-detail',
  templateUrl: './import-setting-detail.component.html',
  styleUrls: ['./import-setting-detail.component.scss']
})
export class ImportDetailComponent {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setImportDetailAttr(attr) : null
    this.getSelect()
  }

  getSelect() {
    this.showGrid = false
    this.service.getSelect(Controller, this.importSettingId).subscribe((res: any) => {
