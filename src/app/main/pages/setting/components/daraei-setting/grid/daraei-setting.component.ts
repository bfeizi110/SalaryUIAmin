...
import { DaraeiSettingAttr, setDaraeiSettingAttr } from '../../../../global-attr'

const Controller = 'DaraeiSetting'

@Component({
  templateUrl: './daraei-setting.component.html',
  styleUrls: ['./daraei-setting.component.scss']
})

export class DaraeiSettingComponent implements OnInit {
  ...
  getAttr() {
    ...
    !DaraeiSettingAttr
      ...
      : this.setAttr(DaraeiSettingAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setDaraeiSettingAttr(attr) : null
    this.getSelect()
  }
