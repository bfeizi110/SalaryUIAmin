...
@Component({
  selector: 'other-setting-group-form',
  templateUrl: './other-setting-group-form.component.html',
  styleUrls: ['./other-setting-group-form.component.scss']
})
export class OtherSettingGroupFormComponent implements OnInit {
  ...
  post() {
    this.form.patchValue({ Id: 0, Code_Fld: 0 })
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      formType: this.formType, modatTitle: 'گروه تنظیمات متفرقه',
