...
@Component({
  selector: 'other-group-form',
  templateUrl: './other-group-form.component.html',
  styleUrls: ['./other-group-form.component.scss']
})
export class OtherGroupFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      formType: this.formType, modatTitle: 'تنظیمات گروه',
