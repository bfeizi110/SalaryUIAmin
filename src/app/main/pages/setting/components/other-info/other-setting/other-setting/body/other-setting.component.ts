...
import { OtherSettingAttr, setOtherSettingAttr } from 'src/app/main/pages/global-attr'
...
export class OtherSettingComponent implements OnInit {
  ...
  edit(event) {
    ...
    this.CodeDesc_Fld = event.rowData.OtherSettingDefineDesc_Fld
    this.showForm = true
    this.formType = 'Edit'
  }
  ...
  view(event) {
    ...
    this.CodeDesc_Fld = event.data.OtherSettingDefineDesc_Fld
    this.showForm = true
    this.formType = 'View'
  }
