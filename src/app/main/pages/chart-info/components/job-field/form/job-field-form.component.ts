...
const Controller = 'JobField'

@Component({
  selector: 'job-field-form',
  templateUrl: './job-field-form.component.html',
  styleUrls: ['./job-field-form.component.scss']
})
export class JobFieldFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      CatID: [null],
      CatIDDesc: [{ value: null, disabled: Validation.disable('CatIDDesc') }, Validation.setValidator('CatIDDesc')],
