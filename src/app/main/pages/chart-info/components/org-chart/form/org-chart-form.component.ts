...
const Controller = 'OrgChart'

@Component({
  selector: 'org-chart-form',
  templateUrl: './org-chart-form.component.html',
  styleUrls: ['./org-chart-form.component.scss']
})
export class OrgChartFormComponent implements OnInit {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      ShowTitle: [{ value: null, disabled: Validation.disable('ShowTitle') }, Validation.setValidator('ShowTitle')],
      Status: [{ value: null, disabled: Validation.disable('Status') }, Validation.setValidator('Status')],
  ...
  ngOnInit(): void {
    ...
    this.modalOptions = {
      ...
      modatTitle: 'عناوین واحد سازمانی',
