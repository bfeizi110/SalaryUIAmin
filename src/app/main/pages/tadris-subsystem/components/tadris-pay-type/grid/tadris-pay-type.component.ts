...
import { TadrisPayTypeAttr, setTadrisPayTypeAttr } from 'src/app/main/pages/global-attr'

const Controller = 'TadrisPayType'

@Component({
  templateUrl: './tadris-pay-type.component.html',
  styleUrls: ['./tadris-pay-type.component.scss']
})
export class TadrisPayTypeComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setTadrisPayTypeAttr(attr) : null
    this.getSelect()
  }
