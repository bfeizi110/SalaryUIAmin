...
import { setTadrisFractionTypeAttr, TadrisFractionTypeAttr } from 'src/app/main/pages/global-attr'

const Controller = 'TadrisFractionType'

@Component({
  templateUrl: './tadris-fraction-type.component.html',
  styleUrls: ['./tadris-fraction-type.component.scss']
})
export class TadrisFractionTypeComponent implements OnInit {
  ...
  formObj: any
  getAttr() {
    let Attr = TadrisFractionTypeAttr()
    !Attr
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setTadrisFractionTypeAttr(attr) : null
    this.getSelect()
  }
