...
import { CostCenter2PrsInfoAttr, setCostCenter2PrsInfoAttr } from 'src/app/main/pages/global-attr'

const Controller = 'CostCenter2PrsInfo'

@Component({
  selector: 'person-cost-center2',
  templateUrl: './person-cost-center2.component.html',
  styleUrls: ['./person-cost-center2.component.scss']
})
export class PersonCostCenter2Component {
  ...
  getAttr() {
    this.showGrid = false
    let Attr = CostCenter2PrsInfoAttr()
    !Attr
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setCostCenter2PrsInfoAttr(attr) : null
    this.getSelect()
  }
