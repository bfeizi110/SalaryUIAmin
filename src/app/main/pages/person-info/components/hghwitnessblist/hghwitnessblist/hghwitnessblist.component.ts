...
import { HghWitnessBListAttr, setHghWitnessBListAttr } from 'src/app/main/pages/global-attr'

const Controller = 'HghWitnessBList'

@Component({
  templateUrl: './hghwitnessblist.component.html',
  styleUrls: ['./hghwitnessblist.component.scss']
})
export class HghWitnessBListComponent implements OnInit {
  ...
  setAttr(attr, type?) {
    ...
    type == 'toLocal' ? setHghWitnessBListAttr(attr) : null
    this.getSelect()
  }
