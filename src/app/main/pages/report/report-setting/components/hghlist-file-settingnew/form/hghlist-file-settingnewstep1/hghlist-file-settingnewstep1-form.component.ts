...
const Controller = 'HghListFileSettingOrder'

@Component({
  selector: 'hghlist-file-settingnewstep1-form',
  templateUrl: './hghlist-file-settingnewstep1-form.component.html',
  styleUrls: ['./hghlist-file-settingnewstep1-form.component.scss']
})
export class HghlistFileSettingNewStep1FormComponent {
