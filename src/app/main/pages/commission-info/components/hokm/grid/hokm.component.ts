...
import { HokmAttr, setHokmAttr } from 'src/app/main/pages/global-attr'

const Controller = 'Hokm'

@Component({
  templateUrl: './hokm.component.html',
  styleUrls: ['./hokm.component.scss']
})
export class HokmComponent implements OnInit {
  ...
  getAttr() {
    ...
    !HokmAttr
      ...
      : this.setAttr(HokmAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setHokmAttr(attr) : null
    this.getSelect()
  }
