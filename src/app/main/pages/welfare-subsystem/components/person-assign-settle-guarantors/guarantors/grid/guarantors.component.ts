...
import { GuarantorsAttr, setGuarantorsAttr } from 'src/app/main/pages/global-attr'
...
export class GuarantorsComponent implements OnInit {
  ...
  getAttr() {
    ...
    !GuarantorsAttr
      ...
      : this.setAttr(GuarantorsAttr)
  }

  setAttr(attr, type?) {
    this.gridOption.columnDefs = attr
    this.formObj = attr.EntityAttribute
    type == 'toLocal' ? setGuarantorsAttr(attr) : null
    this.getSelect()
  }
  ...
  getSelect() {
    ...
    this.service.getSelect(Controller, this.ParentID).subscribe((res: any) => {
      ...
      this.showGrid = true
      setTimeout(() => {
        this.service.scrollToElement('guarantors')
      }, 200); 
    })
  }
