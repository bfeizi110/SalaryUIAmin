...
const Controller = 'PersonAssignSaving'

@Component({
  selector: 'person-assign-saving-form',
  templateUrl: './person-assign-saving-form.component.html',
  styleUrls: ['./person-assign-saving-form.component.scss']
})
export class PersonAssignSavingFormComponent {
  ...
  setForm() {
    ...
    this.form = this.formBuilder.group({
      ...
      OfferDate_Fld: [{ value: null, disabled: Validation.disable('OfferDate_Fld') }, Validation.setValidator('OfferDate_Fld')],
